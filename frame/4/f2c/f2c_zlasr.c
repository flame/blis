/* f2c_zlasr.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 on Linux or Unix systems, link with .../path/to/libf2c.a -lm or, if you install libf2c.a in a standard place, with -lf2c -lm -- in that order, at the end of the command line, as in cc *.o -lf2c -lm Source for libf2c is in /netlib/f2c/libf2c.zip, e.g., http://www.netlib.org/f2c/libf2c.zip */
 #include "blis.h" /* > \brief \b ZLASR applies a sequence of plane rotations to a general rectangular matrix. */
 /* =========== DOCUMENTATION =========== */
 ...
 /* > \verbatim */
 /* > */
 /* > ZLASR applies a sequence of bla_real plane rotations to a bla_scomplex matrix */
 ...
 i__3 = j + 1 + i__ * a_dim1;
 z__2.real = ctemp * temp.real, z__2.imag = ctemp * temp.imag;
 i__4 = j + i__ * a_dim1;
 z__3.real = stemp * a[i__4].real, z__3.imag = stemp * a[ i__4].imag;
 z__1.real = z__2.real - z__3.real, z__1.imag = z__2.imag - z__3.imag;
 a[i__3].real = z__1.real, a[i__3].imag = z__1.imag;
 i__3 = j + i__ * a_dim1;
 z__2.real = stemp * temp.real, z__2.imag = stemp * temp.imag;
 i__4 = j + i__ * a_dim1;
 z__3.real = ctemp * a[i__4].real, z__3.imag = ctemp * a[ i__4].imag;
 z__1.real = z__2.real + z__3.real, z__1.imag = z__2.imag + z__3.imag;
 a[i__3].real = z__1.real, a[i__3].imag = z__1.imag;
 /* L10: */
 }
 ...
 z__2.real = ctemp * temp.real, z__2.imag = ctemp * temp.imag;
 i__3 = j + i__ * a_dim1;
 z__3.real = stemp * a[i__3].real, z__3.imag = stemp * a[ i__3].imag;
 z__1.real = z__2.real - z__3.real, z__1.imag = z__2.imag - z__3.imag;
 a[i__2].real = z__1.real, a[i__2].imag = z__1.imag;
 i__2 = j + i__ * a_dim1;
 z__2.real = stemp * temp.real, z__2.imag = stemp * temp.imag;
 i__3 = j + i__ * a_dim1;
 z__3.real = ctemp * a[i__3].real, z__3.imag = ctemp * a[ i__3].imag;
 z__1.real = z__2.real + z__3.real, z__1.imag = z__2.imag + z__3.imag;
 a[i__2].real = z__1.real, a[i__2].imag = z__1.imag;
 /* L30: */
 }
 ...
 i__3 = j + i__ * a_dim1;
 i__4 = *m + i__ * a_dim1;
 z__2.real = stemp * a[i__4].real, z__2.imag = stemp * a[ i__4].imag;
 z__3.real = ctemp * temp.real, z__3.imag = ctemp * temp.imag;
 z__1.real = z__2.real + z__3.real, z__1.imag = z__2.imag + z__3.imag;
 a[i__3].real = z__1.real, a[i__3].imag = z__1.imag;
 i__3 = *m + i__ * a_dim1;
 i__4 = *m + i__ * a_dim1;
 z__2.real = ctemp * a[i__4].real, z__2.imag = ctemp * a[ i__4].imag;
 z__3.real = stemp * temp.real, z__3.imag = stemp * temp.imag;
 z__1.real = z__2.real - z__3.real, z__1.imag = z__2.imag - z__3.imag;
 a[i__3].real = z__1.real, a[i__3].imag = z__1.imag;
 /* L90: */
 }
 ...
 i__2 = j + i__ * a_dim1;
 i__3 = *m + i__ * a_dim1;
 z__2.real = stemp * a[i__3].real, z__2.imag = stemp * a[ i__3].imag;
 z__3.real = ctemp * temp.real, z__3.imag = ctemp * temp.imag;
 z__1.real = z__2.real + z__3.real, z__1.imag = z__2.imag + z__3.imag;
 a[i__2].real = z__1.real, a[i__2].imag = z__1.imag;
 i__2 = *m + i__ * a_dim1;
 i__3 = *m + i__ * a_dim1;
 z__2.real = ctemp * a[i__3].real, z__2.imag = ctemp * a[ i__3].imag;
 z__3.real = stemp * temp.real, z__3.imag = stemp * temp.imag;
 z__1.real = z__2.real - z__3.real, z__1.imag = z__2.imag - z__3.imag;
 a[i__2].real = z__1.real, a[i__2].imag = z__1.imag;
 /* L110: */
