/* f2c_dorgtr.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 /* > \verbatim */
 /* > */
 /* > DORGTR generates a bla_real orthogonal matrix Q which is defined as the */
 ...
 *info = -7;
 ...
 i__2 = *n - 1;
 i__3 = *n - 1;
 nb = f2c_ilaenv_(&c__1, "DORGQL", " ", &i__1, &i__2, &i__3, &c_n1, (ftnlen)6, (ftnlen)1);
 }
 else {
 i__1 = *n - 1;
 i__2 = *n - 1;
 i__3 = *n - 1;
 nb = f2c_ilaenv_(&c__1, "DORGQR", " ", &i__1, &i__2, &i__3, &c_n1, (ftnlen)6, (ftnlen)1);
 }
 /* Computing MAX */
 i__1 = 1, i__2 = *n - 1;
 ...
 i__2 = *n - 1;
 i__3 = *n - 1;
 f2c_dorgql_(&i__1, &i__2, &i__3, &a[a_offset], lda, &tau[1], &work[1], lwork, &iinfo);
 }
 else {
 ...
 i__2 = *n - 1;
 i__3 = *n - 1;
 f2c_dorgqr_(&i__1, &i__2, &i__3, &a[(a_dim1 << 1) + 2], lda, &tau[1], &work[1], lwork, &iinfo);
 }
 }
 work[1] = (bla_double) lwkopt;
 return 0;
