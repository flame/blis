/* f2c_zhetd2.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
;
 ...
 /* > \brief \b ZHETD2 reduces a Hermitian matrix to bla_real symmetric tridiagonal form by an unitary similarity t ransformation (unblocked algorithm). */
 /* =========== DOCUMENTATION =========== */
 ...
 /* > \verbatim */
 /* > */
 /* > ZHETD2 reduces a bla_scomplex Hermitian matrix A to bla_real symmetric */
 ...
 *info = -4;
 ...
 i__2 = *n + *n * a_dim1;
 d__1 = a[i__2].real;
 a[i__1].real = d__1, a[i__1].imag = 0.;
 for (i__ = *n - 1;
 i__ >= 1;
 --i__) {
 ...
 f2c_zlarfg_(&i__, &alpha, &a[(i__ + 1) * a_dim1 + 1], &c__1, &taui);
 i__1 = i__;
 e[i__1] = alpha.real;
 ...
 z__2.real = z__3.real * taui.real - z__3.imag * taui.imag, z__2.imag = z__3.real * taui.imag + z__3.imag * taui.real;
 f2c_zdotc_(&z__4, &i__, &tau[1], &c__1, &a[(i__ + 1) * a_dim1 + 1] , &c__1);
 ...
 i__1 = i__ + (i__ + 1) * a_dim1;
 i__2 = i__;
 a[i__1].real = e[i__2], a[i__1].imag = 0.;
 i__1 = i__ + 1;
 ...
 /* Computing MIN */
 i__3 = i__ + 2;
 f2c_zlarfg_(&i__2, &alpha, &a[bla_a_min(i__3,*n) + i__ * a_dim1], &c__1, & taui);
 i__2 = i__;
 e[i__2] = alpha.real;
 if (taui.real != 0. || taui.imag != 0.) {
 ...
 z__2.real = z__3.real * taui.real - z__3.imag * taui.imag, z__2.imag = z__3.real * taui.imag + z__3.imag * taui.real;
 i__2 = *n - i__;
 f2c_zdotc_(&z__4, &i__2, &tau[i__], &c__1, &a[i__ + 1 + i__ * a_dim1], &c__1);
 z__1.real = z__2.real * z__4.real - z__2.imag * z__4.imag, z__1.imag = z__2.real * z__4.imag + z__2.imag * z__4.real;
 alpha.real = z__1.real, alpha.imag = z__1.imag;
 i__2 = *n - i__;
 ...
 i__2 = i__ + 1 + i__ * a_dim1;
 i__3 = i__;
 a[i__2].real = e[i__3], a[i__2].imag = 0.;
 i__2 = i__;
 i__3 = i__ + i__ * a_dim1;
