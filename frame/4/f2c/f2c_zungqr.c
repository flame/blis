/* f2c_zungqr.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 /* > \verbatim */
 /* > */
 /* > ZUNGQR generates an M-by-N bla_scomplex matrix Q with orthonormal columns, */
 ...
 /* Function Body */
 *info = 0;
 nb = f2c_ilaenv_(&c__1, "ZUNGQR", " ", m, n, k, &c_n1, (ftnlen)6, (ftnlen)1);
 ...
 *info = -8;
 ...
 /* Computing MAX */
 i__1 = 0, i__2 = f2c_ilaenv_(&c__3, "ZUNGQR", " ", m, n, k, &c_n1, (ftnlen)6, (ftnlen)1);
 ...
 nb = *lwork / ldwork;
 /* Computing MAX */
 i__1 = 2, i__2 = f2c_ilaenv_(&c__2, "ZUNGQR", " ", m, n, k, &c_n1, (ftnlen)6, (ftnlen)1);
 ...
 i__2 = *n - kk;
 i__3 = *k - kk;
 f2c_zung2r_(&i__1, &i__2, &i__3, &a[kk + 1 + (kk + 1) * a_dim1], lda, & tau[kk + 1], &work[1], &iinfo);
 }
 if (kk > 0) {
 /* Use blocked code */
 i__1 = -nb;
 ...
 i__2 = *m - i__ + 1;
 f2c_zlarft_("Forward", "Columnwise", &i__2, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], &work[1], &ldwork, (ftnlen)7, (ftnlen)10);
 /* Apply H to A(i:m,i+ib:n) from the left */
 i__2 = *m - i__ + 1;
 i__3 = *n - i__ - ib + 1;
 f2c_zlarfb_("Left", "No transpose", "Forward", "Columnwise", & i__2, &i__3, &ib, &a[i__ + i__ * a_dim1], lda, &work[ 1], &ldwork, &a[i__ + (i__ + ib) * a_dim1], lda, & work[ib + 1], &ldwork, (ftnlen)4, (ftnlen)12, (ftnlen)7, (ftnlen)10);
 }
 /* Apply H to rows i:m of current block */
 i__2 = *m - i__ + 1;
 f2c_zung2r_(&i__2, &ib, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], & work[1], &iinfo);
