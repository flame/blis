/* f2c_zung2l.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 ...
 /* > \verbatim */
 /* > */
 /* > ZUNG2L generates an m by n bla_scomplex matrix Q with orthonormal columns, */
 ...
 *info = -5;
 ...
 i__2 = *m - *n + ii;
 i__3 = ii - 1;
 f2c_zlarf_("Left", &i__2, &i__3, &a[ii * a_dim1 + 1], &c__1, &tau[i__], & a[a_offset], lda, &work[1], (ftnlen)4);
 i__2 = *m - *n + ii - 1;
 i__3 = i__;
 ...
 i__2 = *m - *n + ii + ii * a_dim1;
 i__3 = i__;
 z__1.real = 1. - tau[i__3].real, z__1.imag = 0. - tau[i__3].imag;
