/* f2c_clascl.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
 on Linux or Unix systems, link with .../path/to/libf2c.a -lm or, if you install libf2c.a in a standard place, with -lf2c -lm -- in that order, at the end of the command line, as in cc *.o -lf2c -lm Source for libf2c is in /netlib/f2c/libf2c.zip, e.g., http://www.netlib.org/f2c/libf2c.zip */
 #include "blis.h" /* > \brief \b CLASCL multiplies a general rectangular matrix by a bla_real scalar defined as cto/cfrom. */
 /* =========== DOCUMENTATION =========== */
 ...
 /* > \verbatim */
 /* > */
 /* > CLASCL multiplies the M by N bla_scomplex matrix A by the bla_real scalar */
 ...
 *info = -9;
 ...
 i__3 = i__ + j * a_dim1;
 i__4 = i__ + j * a_dim1;
 q__1.real = mul * a[i__4].real, q__1.imag = mul * a[i__4].imag;
