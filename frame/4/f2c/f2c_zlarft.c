/* f2c_zlarft.f -- translated by f2c (version 20100827). You must link the resulting object file with libf2c: on Microsoft Windows system, link with libf2c.lib;
...
;
 ...
 /* > \verbatim */
 /* > */
 /* > ZLARFT forms the triangular factor T of a bla_scomplex block reflector H */
 ...
 */
 ...
 i__2 = i__;
 if (tau[i__2].real == 0. && tau[i__2].imag == 0.) {
 /* H(i) = I */
 i__2 = i__;
 for (j = 1;
 j <= i__2;
 ...
 if (v[i__3].real != 0. || v[i__3].imag != 0.) {
 break;
 }
 }
 i__2 = i__ - 1;
 ...
 i__3 = j + i__ * t_dim1;
 i__4 = i__;
 z__2.real = -tau[i__4].real, z__2.imag = -tau[i__4].imag;
 bla_d_cnjg(&z__3, &v[i__ + j * v_dim1]);
 z__1.real = z__2.real * z__3.real - z__2.imag * z__3.imag, z__1.imag = z__2.real * z__3.imag + z__2.imag * z__3.real;
 t[i__3].real = z__1.real, t[i__3].imag = z__1.imag;
 }
 ...
 i__3 = i__ - 1;
 i__4 = i__;
 z__1.real = -tau[i__4].real, z__1.imag = -tau[i__4].imag;
 ...
 z__2.real = -tau[i__4].real, z__2.imag = -tau[i__4].imag;
 i__5 = j + i__ * v_dim1;
 z__1.real = z__2.real * v[i__5].real - z__2.imag * v[i__5].imag, z__1.imag = z__2.real * v[i__5].imag + z__2.imag * v[i__5] .real;
 t[i__3].real = z__1.real, t[i__3].imag = z__1.imag;
 }
 j = bla_a_min(lastv,prevlastv);
 ...
 if (v[i__2].real != 0. || v[i__2].imag != 0.) {
 break;
 }
 }
 i__1 = *k;
 ...
 i__2 = j + i__ * t_dim1;
 i__3 = i__;
 z__2.real = -tau[i__3].real, z__2.imag = -tau[i__3].imag;
 bla_d_cnjg(&z__3, &v[*n - *k + i__ + j * v_dim1]);
 z__1.real = z__2.real * z__3.real - z__2.imag * z__3.imag, z__1.imag = z__2.real * z__3.imag + z__2.imag * z__3.real;
 t[i__2].real = z__1.real, t[i__2].imag = z__1.imag;
 }
 ...
 i__2 = *k - i__;
 i__3 = i__;
 z__1.real = -tau[i__3].real, z__1.imag = -tau[i__3].imag;
 ...
 z__1.real = z__2.real * v[i__4].real - z__2.imag * v[i__4].imag, z__1.imag = z__2.real * v[i__4].imag + z__2.imag * v[ i__4].real;
 t[i__2].real = z__1.real, t[i__2].imag = z__1.imag;
 }
 j = bla_a_max(lastv,prevlastv);
