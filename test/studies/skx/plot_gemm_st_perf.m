...
output_st_sgemm_asm_blis_haswell
output_st_dgemm_asm_blis_haswell
output_st_cgemm_1m_blis_haswell
output_st_zgemm_1m_blis_haswell
...
plot(data_st_sgemm_asm_blis_haswell(:,1), data_st_sgemm_asm_blis_haswell(:,5), '--', 'LineWidth', 1.25,'Color', [0 0 1]);
...
plot(data_st_dgemm_asm_blis_haswell(:,1), data_st_dgemm_asm_blis_haswell(:,5),'--', 'LineWidth', 1.25,'Color', [0 0 1]);
...
plot(data_st_cgemm_1m_blis_haswell(:,1), data_st_cgemm_1m_blis_haswell(:,5), 'LineWidth', 1.25,'Color', [0 0 1]);
...
plot(data_st_zgemm_1m_blis_haswell(:,1), data_st_zgemm_1m_blis_haswell(:,5), '--', 'LineWidth', 1.25,'Color', [0 0 1]);
